  ...
  return (
    <Navbar className="border-b-2">
      ...
      <div className="flex gap-2 md:order-2">
        ...
        <SignedOut>
          <Link href='/sign-in'>
          <Button gradientDuoTone="purpleToBlue" outline as='div'>
            Sign In
          </Button>
          </Link>
        </SignedOut>
...
//     variables: {
//       colorPrimary: theme === "light" ? "#6366f1" : "#8b5cf6", // Example primary color
//     },
//     general: {
//       colorScheme: theme, // Dynamically set light or dark
//     },
//   };
